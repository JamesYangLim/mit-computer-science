...
for i in range(count):
    if i < 4 and count - 5 < i:
        continue

    if mess[i].islower() and \
       mess[i-4].islower() and mess[i-3].isupper() and mess[i-2].isupper() and mess[i-1].isupper() and \
       mess[i+1].isupper() and mess[i+2].isupper() and mess[i+3].isupper() and mess[i+4].islower():
            code += mess[i]
