...
# xVals = range(-10, 11, 1)
# a, b, c = 3, 0, 0
# genNoisyParabolicData(a, b, c, xVals, 'Mystery Data')
...
# # Fit models1 on dataset 2 and models2 on dataset 1
# testFits(models1, degrees, xVals2, yVals2, 'Dataset 2/Model 1.txt')
# plt.figure()
# testFits(models2, degrees, xVals1, yVals1, 'Dataset 1/Model 2.txt')
# plt.show()
...
plt.plot(xVals, estYVals, 'r--', label = 'Predictive values')
